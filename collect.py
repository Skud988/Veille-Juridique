...
# ── SOURCES RSS ─────────────────────────────
RSS_SOURCES = [
    {"url":"https://www.cnil.fr/fr/rss.xml",                          "source":"CNIL",                  "default_cat":"cnil"},
    {"url":"https://www.arcom.fr/nos-ressources/espace-presse/communiques-de-presse/rss", "source":"ARCOM","default_cat":"institutionnel"},
    {"url":"https://www.sacem.fr/rss/actualites",                     "source":"SACEM",                 "default_cat":"musique"},
    {"url":"https://www.culture.gouv.fr/Presse/Communiques-de-presse/rss","source":"Min. Culture",     "default_cat":"institutionnel"},
    {"url":"https://www.dalloz-actualite.fr/rss/tous-les-contenus",   "source":"Dalloz Actualité",      "default_cat":"justice"},
    {"url":"https://www.legalis.net/feed/",                           "source":"Légalis",               "default_cat":"ia"},
    {"url":"https://www.village-justice.com/rss/rss.xml",             "source":"Village Justice",       "default_cat":"justice"},
    {"url":"https://www.legifrance.gouv.fr/feeds/jorf",               "source":"Journal Officiel",      "default_cat":"loi"},
    {"url":"https://www.billboard.com/feed/",                         "source":"Billboard",             "default_cat":"musique"},
    {"url":"https://musically.com/feed/",                             "source":"Music Ally",            "default_cat":"musique"},
    {"url":"https://www.musicbusinessworldwide.com/feed/",            "source":"Music Business Worldwide","default_cat":"musique"},
    {"url":"https://www.ifpi.org/feed/",                              "source":"IFPI",                  "default_cat":"musique"},
]
...
def generate_summary(title, description):
    """Résumé IA si clé dispo, sinon extrait brut."""
    ...
    try:
        resp = requests.post(
            ...
            json={"model":"claude-haiku-4-5-20251001","max_tokens":150,"messages":[{
                "role":"user",
                "content":(f"Tu es juriste spécialisé droit de la musique/numérique. "
                           f"Résume en 2 phrases max (200 car.) pour une veille juridique. "
                           f"Titre: {title}\nDescription: {clean_html(description)[:500]}\n"
                           f"Uniquement le résumé, sans intro.")
            }]},
            timeout=10
        )
        if resp.status_code == 200:
            text = resp.json().get("content",[{}])[0].get("text","").strip()
            if text: return text, "résumé IA"
...
def collect_rss():
    ...
    for cfg in RSS_SOURCES:
        ...
        for entry in feed.entries[:25]:
            ...
            summary, stype = generate_summary(title, desc)
